...
import cgi
import time
from Heap__Sort import HeapSort

class MainPage( webapp.RequestHandler ):

  def get( self ):
    self.response.headers['Content-Type'] = 'text/html'
    self.response.out.write('<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> <title>HeapSort on Google App Engine</title>')
...
<div id="hd" role="banner"><h1>HeapSort</h1></div>
<div id="bd" role="main">
...
<form action="/search" method="post" id="mainform">
        ...
        self.response.write('<div id="ft" role="contentinfo"><p>Created by @<a href="http://thinkphp.ro">Adrian Statescu</a> | <a href="https://github.com/thinkphp/heapsortpy">Fork on GitHub</a></p></div>')
